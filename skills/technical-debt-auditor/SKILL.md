...
purpose: "Identify and classify technical debt across code, architecture, tests, documentation, and process, then recommend repayment priorities."
...
handoffs: ["maintainability-reviewer", "quality-risk-register-builder", "quality-evidence-summarizer"]
---
# technical-debt-auditor

## Purpose
Identify and classify technical debt across code, architecture, tests, documentation, and process, then recommend repayment priorities.
