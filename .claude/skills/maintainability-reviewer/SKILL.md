...
purpose: "Review a system for maintainability risks such as coupling, complexity, weak tests, poor structure, and difficult change paths."
...
handoffs: ["technical-debt-auditor", "quality-risk-register-builder", "quality-evidence-summarizer"]
---
# maintainability-reviewer

## Purpose
Review a system for maintainability risks such as coupling, complexity, weak tests, poor structure, and difficult change paths.
